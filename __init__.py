...
while True:
    ...
    if option == 4:
        ...
        number = input("please enter the clients number: ")
        email = input("please enter the clients email: ")
        instagram = input("please enter the client instagram (leave empty it does not have it): ")
        cpf = input("please enter the client cpf: ")
